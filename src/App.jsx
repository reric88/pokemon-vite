...
'Zygarde']
  ...
  const getAbilities = (abilities) => {
    if (abilities && abilities.length === 0){
      ...
      return abilities[0].ability.name.slice(0,1).toUpperCase() + abilities[0].ability.name.slice(1)
    } 
    else if (abilities && abilities.length >= 2){
      return abilities[0].ability.name.slice(0,1).toUpperCase() + abilities[0].ability.name.slice(1) 
      + ' / ' + 
      abilities[1].ability.name.slice(0,1).toUpperCase() + abilities[1].ability.name.slice(1)
    } 
    // else {
    //   return abilities[0].ability.name + <br></br> + abilities[1].ability.name + <br></br> + abilities[2].ability.name
    // }
  }
